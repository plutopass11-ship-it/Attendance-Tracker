...
document.addEventListener('DOMContentLoaded', () => {
    ...
    loginForm.addEventListener('submit', async (e) => {
        e.preventDefault();
        const host = 'https://review.flyingpluto.ai';
        ...
        const user = await Auth.login(id, pass, host);
        ...
        if (user) {
            ...
            errBox.textContent = 'Invalid credentials or CORS restriction. Check console for details.';
